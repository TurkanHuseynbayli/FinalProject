...
namespace BackEnd.Migrations
{
    ...
    [Migration("20210311132600_BlogCommentsTable")]
    partial class BlogCommentsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Models.TabList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackEnd.Models.TablistProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("TabListId");

                    b.ToTable("TablistProducts");
                });

            modelBuilder.Entity("BackEnd.ViewModels.SubscribedEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackEnd.Models.TablistProduct", b =>
                {
                    b.HasOne("BackEnd.Models.Product", "Product")
                        .WithMany("TablistProduct")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackEnd.Models.TabList", "TabList")
                        .WithMany("TablistProduct")
                        .HasForeignKey("TabListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
